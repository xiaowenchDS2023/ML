...
logistic_regression_model_path = "C:/Users/armen/Downloads/EC-utbildning/2024-V.7-Machine learning/Xiaowen_Chen inlämningsuppgifter/logistic_regression_model(2).pkl"
logistic_regression_model = joblib.load(logistic_regression_model_path)

# Load random forest model
random_forest_model_path = "C:/Users/armen/Downloads/EC-utbildning/2024-V.7-Machine learning/Xiaowen_Chen inlämningsuppgifter/random_forest_model(2).pkl"
